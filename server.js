...
const PRODUCTS = {
  stend: {
    ...
    zipName: 'stend.zip',
    contents: ["Чертежи КОМПАС v18.1", "3D модели КОМПАС v18.1", "Паспорт, РЭ"]
  },
  stapel: {
  ...
  vent: {
    ...
    zipName: 'vent.zip',
    contents: ["Сборочный чертеж JPG", "3D модель КОМПАС", "Видеоинструкция по изготовлению", "Файл STEP"]
  },
  level: {
